...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference("Deal.count") do
      post deals_url, params: { deal: { amount: @deal.amount, category_id: @deal.category_id, name: @deal.name, user_id: @deal.user_id } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { amount: @deal.amount, category_id: @deal.category_id, name: @deal.name, user_id: @deal.user_id } }
